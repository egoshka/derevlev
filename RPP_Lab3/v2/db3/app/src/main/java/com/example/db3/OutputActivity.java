...
public class OutputActivity extends AppCompatActivity {
    ...
    public void onResume() {
        ...
        while (userCursor.moveToNext()) {
            map = new HashMap<>();
            map.put("Name", userCursor.getString(userCursor.getColumnIndex(DatabaseHelper.COLUMN_F)) +
                    userCursor.getString(userCursor.getColumnIndex(DatabaseHelper.COLUMN_I)) +
                    userCursor.getString(userCursor.getColumnIndex(DatabaseHelper.COLUMN_O)));
